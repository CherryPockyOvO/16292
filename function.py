...
def get_news(msg):  # 新闻查询
    headers = {
        ...
        "Cookie": "SINAGLOBAL=Sp2rmf5rKbDpISKBa4rMue0Avf-V-AiqUlrRBkCS9z-XbFG148W0oo29WL5uEeQLYRGUgrsizYX3ukkF2SrTiUda7bj41gXObnJ_lwp11SFJl9IKkwsFxKedWo925wJEM-E_Ugt-B221WXKuWLit1Q==",  # 必须项！
	...
	try:
		for filename in os.listdir(image_folder): 
			if filename.endswith(".jpg"):
				...
				image = fr.load_image_file(image_path,mode = 'RGB')
				try:
		...
		for face_encoding in face_encodings:  # 遍历检测到的人脸
			matches = fr.compare_faces(known_face_encodings, face_encoding,tolerance = 0.4)  # 与已知的人脸进行比对
